...
# 运行单靶标标定 
# --target target_multi.yaml ， eg. /home/songshu/Repos/kalibr_ws/datas/april_6x6.yaml
...
rosrun kalibr kalibr_calibrate_cameras --target datas/april_6x6.yaml --bag ${image_path}/fisheye.bag --models ${camera_model} --topics /cam0/image_raw > ${image_path}/compute_calib.log
